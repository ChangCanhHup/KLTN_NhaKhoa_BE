...
let createUserForAdmin = async (data) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      if (check === true) {
        ...
        await db.User.create({
          ...
          phonenumber: data.phonenumber,
          gender: data.gender,
          roleId: data.roleId || "R3", // Default roleId to R3
          positionId: data.positionId || null, // Default positionId to null
          image: data.image,
          status: data.status ? data.status : 0,
          medicalHistoryHTML: data.medicalHistoryHTML || "", // Default to empty string
          medicalHistoryMarkdown: data.medicalHistoryMarkdown || "", // Default to empty string
        });
        resolve({
          errCode: 0,
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      if (user) {
        ...
        user.medicalHistoryHTML =
          data.medicalHistoryHTML || user.medicalHistoryHTML;
        user.medicalHistoryMarkdown =
          data.medicalHistoryMarkdown || user.medicalHistoryMarkdown;
...
module.exports = {
  ...
  editUserForAdmin: editUserForAdmin,
